...
const GOLF_APP_DATA = {
  ...
  prizes: [
    ...
    },
    {
      category: '個人戦',
      rank: '部門長賞（全28賞） 🎁',
      title: '各部門長より豪華協賛景品（計28名様）',
      desc: '各部門長よりご協賛いただいた豪華景品！',
      tag: '飛び賞28本',
      icon: 'gift',
      depts: [
        '4位: 総本', '5位: CB本', '6位: R', '7位: V', '8位: 品本', '9位: 調本',
        '10位: 生本', '11位: 技本', '12位: AI統', '13位: 経本', '14位: L社',
        '15位: 栄社', '16位: YOC社', '17位: RE', '18位: 東科大', '19位: GCM',
        '20位: 調本副', '25位: VS', '30位: 生技', '35位: 総RM', '40位: RC',
        '45位: M工産', '50位: 品本証', '55位: 生技次', '60位: 人事次',
        '65位: R技Ｐ', '70位: T推', '75位: 技管'
      ]
    },
    {
      category: '個人戦',
